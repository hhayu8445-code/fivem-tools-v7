...
// ═══════════════════════════════════════════════════════════════════════════
// 🔥 FiveCFX Decrypt Bot - Web Server
...
app.use((req, res) => {
    ...
    <body>
        ...
        <footer style="position: fixed; bottom: 0; left: 0; right: 0; display: flex; align-items: center; justify-content: space-between; padding: 1rem; color: hsl(var(--muted-foreground)); font-size: 0.875rem; background: hsl(var(--background)); border-top: 1px solid hsl(var(--border));">
            <a href="https://fivecfx.com" target="_blank" style="color: hsl(var(--muted-foreground)); text-decoration: none; display: flex; align-items: center; transition: color 0.2s;" onmouseover="this.style.color='hsl(var(--foreground))'" onmouseout="this.style.color='hsl(var(--muted-foreground))'">
                🔥 FiveCFX
            </a>
            <a href="https://discord.fivecfx.com" target="_blank" style="color: hsl(var(--muted-foreground)); text-decoration: none; display: flex; align-items: center; transition: color 0.2s;" onmouseover="this.style.color='hsl(var(--foreground))'" onmouseout="this.style.color='hsl(var(--muted-foreground))'">
...
function startServer() {
    return new Promise((resolve) => {
        const server = app.listen(config.server.port, '0.0.0.0', () => {
            ...
            console.log('🔥 Powered by FiveCFX - https://fivecfx.com\n');
            resolve(server);
        });
    });
}
